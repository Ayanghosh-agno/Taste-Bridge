      ...
      <div className="space-y-6">
        {audiences.map((audience, index) => (
          <motion.div
            ...
            className="flex items-center justify-between p-4 bg-gray-700/30 rounded-xl hover:bg-gray-700/50 transition-colors duration-200 cursor-pointer group"
          >
            <div className="flex items-center gap-4">
              ...
              <h4 className="text-white font-semibold">{audience.name}</h4>
            </div>
