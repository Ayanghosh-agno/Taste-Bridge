        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            <div className="relative">
              <Globe className="h-8 w-8 text-purple-600 group-hover:text-purple-500 transition-colors duration-200" />
              <div className="absolute inset-0 bg-purple-600/20 rounded-full blur-md group-hover:bg-purple-500/30 transition-all duration-200"></div>
            </div>
                ...
                >
                  {location.pathname === item.path && (
                    <motion.div
                      ...
                      className="absolute inset-0 bg-purple-100 rounded-md"
                      initial={false}
